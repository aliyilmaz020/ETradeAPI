...
{
    public class CreateProductCommandValidator : AbstractValidator<CreateProductCommandRequest>, ICustomValidator
    {
        public CreateProductCommandValidator()
        {
            ...
            RuleFor(x => x.Stock).NotEmpty().WithMessage("Lütfen stok sayısını giriniz.")
                .NotNull().WithMessage("Lütfen stok sayısını giriniz.")
                .Must(s => s >= 0).WithMessage("Stok sayısı negatif olamaz")
                .LessThanOrEqualTo(100).WithMessage("Stok sayısı en fazla 100 olabilir");
            RuleFor(x => x.Price).NotEmpty().WithMessage("Lütfen ürün fiyatını giriniz.").NotNull().WithMessage("Lütfen ürün fiyatını giriniz.")
                ...
                .GreaterThanOrEqualTo(5).WithMessage("Ürün fiyatı en az 5 olabilir");
        }
    }
}
